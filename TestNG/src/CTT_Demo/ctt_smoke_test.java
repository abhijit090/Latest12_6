...
import org.testng.annotations.Test;
	...
	public class ctt_smoke_test {
		...
		public void Navigate_To_The_Project_Menu() throws InterruptedException {
	        ...
	        projectLeadInput.sendKeys("aarushwagh133@gmail.com");
	        WebElement projectLeadOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//li[@id='undefinedcreate-user-option-0' and contains(text(), 'aarushwagh133@gmail.com')]")));
	  ...
	  // Locate the parent div class that contains all the project names
			...
			WebElement project = parentDiv.findElement(By.xpath("(//button[contains(text(),'AaaDemo')])[2]"));
			Thread.sleep(2500);
		...
		public void Open_Same_Project_Check_Header_Tab() throws InterruptedException {
			...
			// Open specific
			WebElement element11 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[contains(text(),'AaaDemo')])[2]")));
			element11.click();
			//iframe
