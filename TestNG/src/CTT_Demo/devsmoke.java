	...
	public class devsmoke {
		...
		public void Navigate_To_The_User_Menu() throws InterruptedException {
	     ...
	     // Locate the parent div class that contains all the project email
	        WebElement modifyUser = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[@row-index='1']//button[@aria-label='Modify User'])[1]")));
	        modifyUser.click();
	        Thread.sleep(3000);
	        //Verify modifiyed user screen open or not 
	        WebElement modifyUserscreen = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//h2[normalize-space()='Modify User'])[1]")));
	        String displayName = modifyUserscreen.getText();
			System.out.println("Screen Name: " + displayName);
	        Thread.sleep(2500);
	        //edit text 
	        WebElement textedit= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='FullNamecreate-user'])[1]")));
	        textedit.sendKeys("TestABCD");
	        Thread.sleep(2500);
	        //click on the is active button 
	        WebElement activeclick = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//label[@id='undefined-create-user-0'])")));
	        activeclick.click();
	        Thread.sleep(1500);
	        // Click on the "Cancel" button
			...
			Thread.sleep(2500);	
			//Unselect all
			 WebElement unselect = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'(Select All)')])[1]")));
		     unselect.click();
		     Thread.sleep(2500);
		    //select particular
		     WebElement select = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'ABCD')])[1]")));
		     select.click();
		     Thread.sleep(2500);
	        //Selecot another one 
		   //select particular with search box 
		     WebElement select2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@aria-label='Search filter values'])[1]")));
		     select2.sendKeys("Christopher Thom");
		     Thread.sleep(1000);
		     select2.sendKeys(Keys.RETURN);
		     Thread.sleep(2500);
		     //Click checkbox 
		     WebElement select12 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("((//*[contains(text(),'Christopher Thompson')])//parent::div//div[@class='ag-wrapper ag-input-wrapper ag-checkbox-input-wrapper ag-checked'])[1]")));
		     select12.click();
		     Thread.sleep(2000);
	        //Clear filter
		     WebElement clrfilter = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[normalize-space()='Clear Filters'])[1]")));
		     clrfilter.click();
		     Thread.sleep(3000);
				...
				Thread.sleep(2500);
				// Wait for the thumbnil icon
				driver.findElement(By.xpath("(//span[@role='presentation'])[9]")).click();
				Thread.sleep(2500);
//				// Click on apply filter button
//				driver.findElement(By.xpath("(//span[@aria-label='filter']//span[@role='presentation'])[1]")).click();
//				Thread.sleep(2500);
				...
				Thread.sleep(2500);
				// select particular
				WebElement select1 = wait.until(
						ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'Shynir@gmail.com')])[1]")));
				select1.click();
				Thread.sleep(2500);
				// Selecot another one
				// select particular with search box
				WebElement select21 = wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("(//input[@aria-label='Search filter values'])[1]")));
				...
				WebElement clrfilter1 = wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("(//button[normalize-space()='Clear Filters'])[1]")));
				clrfilter1.click();
				Thread.sleep(2000);
	    }
		...
		public void Navigate_To_The_Project_Menu() throws InterruptedException {
	        ...
	        Thread.sleep(3000);
	        //Pencil icon***********
	        WebElement modifyUser = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@row-index='1']//button[@aria-label='Modify Project'])[1]")));
	        modifyUser.click();
	        Thread.sleep(3000);
	        //Verify modifiyed user screen open or not 
	        WebElement modifyUserscreen = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//h2[normalize-space()='Modify Project'])[1]")));
	        String displayName = modifyUserscreen.getText();
			System.out.println("Screen Name: " + displayName);
	        Thread.sleep(2500);
	        //edit client discription
	        WebElement disctext = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='Descriptioncreate-user']")));
	        disctext.clear();
	        disctext.sendKeys("ABCDTest");
	        Thread.sleep(2500);
	        //edit domain
	        WebElement disctext1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='undefinedcreate-user'])[2]")));
	      ...
	      //Project Name name apply filter
			...
			//Unselect all
		     ...
		     Thread.sleep(2500);
		    //select particular
		     WebElement select = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'345-4')])[1]")));
		     select.click();
		     Thread.sleep(2500);
	        //Selecot another one 
		   //select particular with search box 
	        ...
	        //Clear filter
		     ...
		     Thread.sleep(3000);
				...
				Thread.sleep(2500);	
				// Unselect all
				WebElement unselect1 = wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'(Select All)')])[1]")));
				unselect1.click();
				Thread.sleep(2500);
				// select particular
				WebElement select1 = wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'ABC')])[1]")));
				select1.click();
				Thread.sleep(2500);
				// Selecot another one
				// select particular with search box
				...
				Thread.sleep(2500);
					...
					Thread.sleep(2500);	
				// Unselect all
				WebElement unselect11 = wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'(Select All)')])[1]")));
				unselect11.click();
				Thread.sleep(2500);
				// select particular
				WebElement select11 = wait.until(ExpectedConditions.visibilityOfElementLocated(
						By.xpath("(//*[contains(text(),'abhishek.mn@pivotree.com')])[1]")));
				select11.click();
				Thread.sleep(2500);
				// Selecot another one
				// select particular with search box
				WebElement select211 = wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("(//input[@aria-label='Search filter values'])[1]")));
				...
				Thread.sleep(2500);
				// Clear filter
				WebElement clrfilter11 = wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("(//button[normalize-space()='Clear Filters'])[1]")));
				clrfilter11.click();
				Thread.sleep(3000);
				...
				Thread.sleep(2500);
						...
						Thread.sleep(2500);	
				// Unselect all
				WebElement unselect111 = wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'(Select All)')])[1]")));
				unselect111.click();
				Thread.sleep(2500);
				// select particular
				WebElement select111 = wait.until(ExpectedConditions.visibilityOfElementLocated(
						By.xpath("(//*[contains(text(),'2024')])[1]")));
				select111.click();
				Thread.sleep(2500);
				//Dropdown 2024
				WebElement select1111 = wait.until(ExpectedConditions.visibilityOfElementLocated(
						By.xpath("//div[contains(@aria-label,'2024 Filter Value')]//span[contains(@class,'ag-set-filter-group-closed-icon')]//span[contains(@role,'presentation')]")));
				select1111.click();
				Thread.sleep(2500);
				
				//Scroll down***************
	         // Find the element using the provided XPath
	            WebElement element = driver.findElement(By.xpath("//div[@class='ag-virtual-list-viewport ag-filter-virtual-list-viewport ag-focus-managed']"));
	            ...
	            Thread.sleep(1500);
				//select May
				WebElement select12 = wait.until(ExpectedConditions.visibilityOfElementLocated(
						By.xpath("//div[contains(@aria-label,'May Filter Value')]//span[contains(@class,'ag-set-filter-group-closed-icon')]//span[contains(@role,'presentation')]")));
...
//	            // Execute JavaScript to scroll to the bottom of the element
				...
				// Find the element using the provided XPath
	            WebElement element1 = driver.findElement(By.xpath("//div[@class='ag-virtual-list-viewport ag-filter-virtual-list-viewport ag-focus-managed']"));
				...
				//select 20 date 
				WebElement unselect15 = wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'20')])[1]")));
				unselect15.click();
				Thread.sleep(2500);
				
				// select particular with search box
				WebElement select2111 = wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("(//input[@aria-label='Search filter values'])[1]")));
				...
				Thread.sleep(2500);
				// Clear filter
				WebElement clrfilter111 = wait.until(ExpectedConditions
						.elementToBeClickable(By.xpath("(//button[normalize-space()='Clear Filters'])[1]")));
				clrfilter111.click();
				Thread.sleep(3000);
	  ...
	  // Locate the parent div class that contains all the project names
		...
		public void Navigate_To_The_Home_Menu_Check_History_menu() throws InterruptedException {	
            ...
            WebElement history = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@class='MuiTypography-root MuiTypography-body1 MuiLink-root MuiLink-underlineHover MuiLink-button css-928f90'][normalize-space()='2.8'])[1]")));
            history.click();
            Thread.sleep(3000);
            //back to same page****************************
		...
		public void Open_Same_Project_Check_Header_Tab() throws InterruptedException {
			...
			Thread.sleep(6000);
			//click on the tree 
			WebElement dashboard1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='dashboardreset']")));
		...
		public void Verifyed_Hedaer_Tab_Attribute_SKU_AGGrid() throws InterruptedException {
			...
			Thread.sleep(3000);
			//Attribute shows
			WebElement rootnode11w = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'Controls & Electrical Components')])[1]")));
			Actions actions1sw = new Actions(driver);
			actions1sw.moveToElement(rootnode11w).perform();
			Thread.sleep(3000);
			WebElement nodeTextElement16w = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='closeicon']/img")));
			nodeTextElement16w.click();
			Thread.sleep(3000);
			
			//Shema show 
			WebElement rootnode11 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'Lights')])[1]")));
		...
		@Test(priority = 11)
		public void Verify_the_open_Assigne_node_and_AddTest_data() throws InterruptedException {
		...
		public void Verified_Node_As_Completed_Or_Not() throws InterruptedException {
			...
			WebElement completedElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'Electrical Cables & Wires')])[3]//following::p[1]")));
			Thread.sleep(2000);
		...
		@Test(priority = 13)
		public void Verify_the_Assignednode_Reintegrated() throws InterruptedException {
				//Locate the parent div class that contains all the project names
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(500));
			// Open specific
			WebElement element11 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[contains(text(),'NewProjectTset')])[2]")));
		...
		@Test(priority = 17)
		public void Verified_Project_Overview_Chart() throws InterruptedException {
			Thread.sleep(3000);
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(500));
			WebElement parentDiv = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='panel1bh-header']")));
			Thread.sleep(2500);
			...
			Thread.sleep(2500);
			// Click on the drop down
			WebElement assignUserButton11ea = wait.until(ExpectedConditions.elementToBeClickable(project.findElement(By.xpath("(//div[@class='MuiAccordionSummary-expandIconWrapper css-1fx8m19'])[4]"))));
			assignUserButton11ea.click();
			Thread.sleep(4000);
			//Assuming the Assign User button is a sibling of the project name, you can use XPath to find it
			WebElement assignUserButton = wait.until(ExpectedConditions.elementToBeClickable(project.findElement(By.xpath("(//*[name()='rect'][@class='MuiBarElement-root MuiBarElement-series-assigned css-ctme2z'])[3]"))));
	        // Click on the Assign User button
			Actions actionsg = new Actions(driver);
			...
			WebElement chartTooltipTable = driver.findElement(By.xpath("(//table[@class='MuiChartsTooltip-table css-rbnde3'])[1]"));
		...
		@Test(priority = 18)
		public void Verifyed_Search_Taxonomy() throws InterruptedException {
			// Open specific
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(500));
				WebElement element11 = driver.findElement(By.xpath("(//button[contains(text(),'NewProjectTset')])[2]"));
				element11.click();
				Thread.sleep(6000);
				// Right-click on root node
		...
		@Test(priority = 19)
		public void open_Assigne_nodePichart() throws InterruptedException {
		...
		public void Remove_the_Node_and_Chek_Datafill_Percentage() throws InterruptedException, AWTException {
			...
			String ProjectJZONalertText11 = alert1111.getText();
			System.out.println("Alert message: " + ProjectJZONalertText11);
			String expectedAlertText1011 = "Unable to create; the selected node has descendants or SKUs.";
			// Accept the alert (click OK or Yes)
			alert1111.accept();
			Thread.sleep(4000);
