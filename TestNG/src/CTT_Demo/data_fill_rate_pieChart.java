package CTT_Demo;
	...
	public class data_fill_rate_pieChart {
...
//		}
		...
		WebElement fileInput = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//ul/li[contains(text(), 'Create JSON from SKU Data...')]")));
