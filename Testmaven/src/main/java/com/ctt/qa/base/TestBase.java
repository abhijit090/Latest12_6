...
import com.ctt.qa.util.TestUtil;
	...
	public class TestBase {
	    ...
	    public TestBase() {
	        try {
	            prop = new Properties();
	            String filePath = "/Users/Abhijit.Jadhav/eclipse-workspace/Testmaven/src/main/java/com/ctt/qa/config/config.properties";
	            System.out.println("Attempting to load properties from: " + filePath);
